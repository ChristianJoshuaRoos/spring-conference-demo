...
public class SessionTest {
    ...
    public void testJpaStartingWith() throws Exception{
        List<Session> sessions = jpaRepository.findBySessionNameStartingWith("Spr");
        assertTrue(sessions.size() > 0);
    }
    ...
    public void testPagingSorting() throws Exception{
        Page<Session> page = jpaRepository.getSessionsWithName("S", PageRequest.of(
                1, 5, Sort.by(Sort.Direction.DESC, "sessionLength")));
